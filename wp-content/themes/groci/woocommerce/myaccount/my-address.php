...
<p>
	<?php echo apply_filters( 'woocommerce_my_account_my_address_description', esc_html__( 'The following addresses will be used on the checkout page by default.', 'groci' ) ); ?>
</p>
...
<?php foreach ( $get_addresses as $name => $title ) : ?>
	...
	<div class="u-column<?php echo ( ( $col = $col * -1 ) < 0 ) ? 1 : 2; ?>  woocommerce-Address">
		<header class="woocommerce-Address-title title">
			<h3><?php echo groci_sanitize_data($title); ?></h3>
