...
class Merlin {
	...
	protected function license() {
        if(groci_get_registered_purchase_code()) {
	...
	protected function plugins() {
        if(empty(groci_get_registered_purchase_code())) {
            echo "<p>".esc_html__('Please verify the purchase code first.','groci')."</p>";
	...
	public function _ajax_activate_license() {
		...
		update_option( 'envato_purchase_code_22502070', $license_key );
